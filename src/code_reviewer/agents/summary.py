...
class SummarizerAgent(BaseAgent):
    ...
    def _section_for_severity(
        ...
        """Generate a section for a severity level."""
    ...
    def _build_recommendation(self, state: ReviewState) -> str:
        ...
        if state.is_blocked:
            lines.append(
                ...
                "Please resolve all critical issues before requesting re-review."
            )
        else:
            stats = state.summary_stats()
            if stats["total_findings"] == 0:
                ...
                lines.append(
                    ...
                    "This PR can be merged after addressing the warnings and suggestions above."
                )
        
        lines.append("")
        lines.append(
            "*This review was generated by an automated multi-agent system. "
            "Please use your judgment and domain knowledge when evaluating suggestions.*"
        )
